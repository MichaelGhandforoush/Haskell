...
tests =
  testGroup
    ...
    [
      ...
      (ValInt 32),
      evalTest
      "Nested OneOf inifinite loop and finite loop"
      ...
      (OneOf (OneOf (ForLoop ("x",CstInt 1) ("i",CstInt 2) (Mul (Var "x") (CstInt 2))) (ForLoop ("x",CstInt 1) ("i",CstInt 3) (Mul (Var "x") (CstInt 2)))) (OneOf (ForLoop ("x",CstInt 1) ("i",CstInt 4) (Mul (Var "x") (CstInt 2))) (ForLoop ("x",CstInt 1) ("i",CstInt 5) (Mul (Var "x") (CstInt 2)))))
      (ValInt 4),
      evalTest
      ...
      (OneOf (OneOf (ForLoop ("x",CstInt 1) ("i",CstInt 4) (Mul (Var "x") (CstInt 2))) (ForLoop ("x",CstInt 1) ("i",CstInt 5) (Mul (Var "x") (CstInt 2))))(OneOf (ForLoop ("x",CstInt 1) ("i",CstInt 2) (Div (Var "x") (CstInt 0))) (ForLoop ("x",CstInt 1) ("i",CstInt 3) (Div (Var "x") (CstInt 0)))))
      (ValInt 16),
      evalTestFail
      ...
      evalTest
      "Test shared state"
      (BothOf (Let "x" (KvPut (CstInt 0) (CstInt 0)) (KvGet (CstInt 1))) (Let "x" (KvPut (CstInt 1) (CstInt 1)) (KvGet (CstInt 0))))
      (ValTuple [ValInt 1, ValInt 0]),
      evalTestFail
      "Test deadlock"
